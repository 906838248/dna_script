...
class InputRecorder:
    ...
    def __init__(self, mouse_mode='absolute', min_mouse_move=20):
        ...
        self.play_thread: Optional[threading.Thread] = None  # 回放线程
    ...
    def play_recording(self, speed_multiplier: float = 1.0, 
        ...
        self.play_thread = threading.Thread(
            ...
            args=(speed_multiplier, stop_callback)
        )
    ...
    def _play_actions(self, speed_multiplier: float, 
        ...
        for action in self.recorded_actions:
            ...
            if action['type'] == 'keyboard':
                ...
                if action['action'] == 'press':
                    ...
                    pydirectinput.keyUp(key)
                    if key in self.playback_pressed_keys:
                        self.playback_pressed_keys.remove(key)
    ...
    def stop_playback(self):
        ...
        # 释放键盘按键
        for key in self.playback_pressed_keys:
            try:
                pydirectinput.keyUp(key)
            except:
                pass
